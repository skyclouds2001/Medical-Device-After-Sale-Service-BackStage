...
const UploadFileForm: React.FC<UploadFileFormProps> = props => {
  ...
  return (
    <>
      <Modal open={props.open} title="上传文件" closable okButtonProps={{ className: 'text-blue-500 border-blue-500 hover:text-white hover:border-transparent' }} onOk={submit} onCancel={cancel}>
