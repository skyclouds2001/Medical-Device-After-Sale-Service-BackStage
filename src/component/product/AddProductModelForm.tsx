...
const AddProductModelForm: React.FC<AddProductModelProps> = props => {
  ...
  return (
    <Modal open={props.open} title="添加产品" closable okText="确认" cancelText="取消" okButtonProps={{ className: 'text-blue-500 border-blue-500 hover:text-white hover:border-transparent' }} destroyOnClose onOk={submit} onCancel={cancel}>
