...
const AddProductTypeForm: React.FC<AddProductTypeProps> = props => {
  ...
  return (
    <Modal open={props.open} title="添加产品大类" closable okButtonProps={{ className: 'text-blue-500 border-blue-500 hover:text-white hover:border-transparent' }} destroyOnClose onOk={submit} onCancel={cancel}>
